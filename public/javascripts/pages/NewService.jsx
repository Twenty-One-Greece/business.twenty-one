    ...
    render(){
        ...
        <div className='row'>
            ...
            <h3>New Service</h3>
                ...
                <MuiThemeProvider>
                <TextField fullWidth={true} floatingLabelText={'Price'} value={this.state.price} onChange={this.handleChange("price")} required={true}/>
                </MuiThemeProvider>
                <br/>
            
                <MuiThemeProvider>
                <TextField fullWidth={true} floatingLabelText={'Price With Tax'} value={this.state.priceWithTax} onChange={this.handleChange("priceWithTax")} required={true}/>
                </MuiThemeProvider>                
